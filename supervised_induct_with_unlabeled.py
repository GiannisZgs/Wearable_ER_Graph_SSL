...
PATH_RESULTS = os.path.join(PATH_FILES,'results_sup_induct_with_unlabeled_'+now_str)
PATH_LOGS = os.path.join(PATH_FILES,'logs_sup_induct_with_unlabeled_'+now_str)
